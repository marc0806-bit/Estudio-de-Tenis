...
\textbf{4.} ¿Cúal es el ranking promedio predominante en las finales y
semifinales de los torneos más importantes?\\
...
El circuito profesional se divide en distintas series de torneos, las
cuales definen la cantidad de puntos en disputa y el nivel de
competitividad, ordenados de manera jerárquica.\\
...
Estas series pertenecen al circuito ATP tour, el cual es el circuito de
tenis profesional masculino de élite en el mundo. Por otro lado, existen
...
\textbf{* Rondas (Round):} A medida que un torneo progresa, el nivel de
...
\begin{verbatim}
## [1] "Registros válidos: 5957 | Cantidad de variables: 12"
\end{verbatim}
...
\toprule
Rank & Promedio & Desviación Estandar & Mediana\\
\midrule
\cellcolor{gray!10}{Winner\_rank} & \cellcolor{gray!10}{19.50} & \cellcolor{gray!10}{14.59} & \cellcolor{gray!10}{16}\\
Loser\_rank & 26.46 & 14.27 & 27\\
\bottomrule
\end{tabular}
\end{table}
\subsection{Efectividad del ranking cómo indicador de éxito}

Se observa que los resultados fuera del pronóstico son tan solo poco más
de un tercio que los resultados esperados, es decir el número de veces
que un jugador con un ranking peor ranking (ranking mayor numéricamente)
venció a un jugador con mejor ranking (ranking menor numéricamente) es b
...
\cellcolor{gray!10}{Hard} & \cellcolor{gray!10}{3779} & \cellcolor{gray!10}{19.18} & \cellcolor{gray!10}{16} & \cellcolor{gray!10}{24.0} & \cellcolor{gray!10}{14.31} & \cellcolor{gray!10}{74.61}\\
\bottomrule
\end{longtable}
